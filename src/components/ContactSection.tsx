    ...
    <section id="contact">
      <div className="csp">
        <div>
          ...
          <ul className="cdl rr d2"><li><span className="cdlb">Email</span><span className="cdlv"> gnareshkumar94@gmail.com</span></li><li><span className="cdlb">Phone</span><span className="cdlv">+91 9025443254</span></li><li><span className="cdlb">Location</span><span className="cdlv">Kumbakonam, Tamil Nadu, India</span></li><li><span className="cdlb">Hours</span><span className="cdlv">Monday - Saturday, 10 am - 6 pm IST</span></li></ul>
        </div>
        <div className="rr d2">
          {!submitted ? (
